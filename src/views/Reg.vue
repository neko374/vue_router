<template>
  <div class="Reg_log_style">
    ...
    <div class="regist_style">
      <div class="left_img"><img src="../assets/images/bg_name_03.png" /></div>
      <div class="right_img"><img src="../assets/images/bg_name_05.png" /></div>
          ...
          <div class="add_regist">
            <ul>
              <li class="frame_style">
                ...
                ><input name="" type="text" id="user_text" /><i>用户名/邮箱</i>
              </li>
              <li class="frame_style">
              ...
              <li class="frame_style">
                <label class="password_icon"></label
                ><input name="" type="password" id="confirm_pwd_text" /><i
                  >确认密码</i
                >
              </li>
              <li class="frame_style">
                <label class="Codes_icon"></label
                ><input name="" type="text" id="Codes_text" /><i>验证码</i>
                <div class="Codes_region"></div>
              </li>
            </ul>
            <div class="auto_login clearfix">
              <p class="clearfix">
                <a id="check_agreement" href="#" class="check_agreement"
                  >我已阅读相关规定</a
                >
                <input id="autoLoginCheck" type="hidden" />
                <span id="agreement_tips" class="auto_tips" style=""></span>
              </p>
              <a href="#" target="_blank" class="forget_pswd" tabindex="-1"
                >《商城用户协议》</a
              >
            </div>
            <div class="center clearfix">
              <a class="btn_pink" id="btn_signin" href="javascript:void(0)"
                >立即注册</a
              >
            </div>
          </div>
